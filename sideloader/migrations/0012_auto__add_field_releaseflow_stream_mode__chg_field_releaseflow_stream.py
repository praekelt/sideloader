...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReleaseFlow.stream_mode'
        db.add_column(u'sideloader_releaseflow', 'stream_mode',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'ReleaseFlow.stream'
        db.alter_column(u'sideloader_releaseflow', 'stream_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ReleaseStream'], null=True))

    def backwards(self, orm):
        # Deleting field 'ReleaseFlow.stream_mode'
        db.delete_column(u'sideloader_releaseflow', 'stream_mode')


        # Changing field 'ReleaseFlow.stream'
        db.alter_column(u'sideloader_releaseflow', 'stream_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sideloader.ReleaseStream']))
    ...
    models = {
        ...
        u'sideloader.releaseflow': {
            ...
            'stream': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sideloader.ReleaseStream']", 'null': 'True'}),
