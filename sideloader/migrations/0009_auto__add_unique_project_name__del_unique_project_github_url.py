...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Project', fields ['github_url']
        db.delete_unique(u'sideloader_project', ['github_url'])

        # Adding unique constraint on 'Project', fields ['name']
        db.create_unique(u'sideloader_project', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['name']
        db.delete_unique(u'sideloader_project', ['name'])

        # Adding unique constraint on 'Project', fields ['github_url']
        db.create_unique(u'sideloader_project', ['github_url'])
