...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModuleManifest'
        db.create_table(u'sideloader_modulemanifest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('structure', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'sideloader', ['ModuleManifest'])

        # Adding model 'ServerManifest'
        db.create_table(u'sideloader_servermanifest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ModuleManifest'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ReleaseFlow'])),
        ))
        db.send_create_signal(u'sideloader', ['ServerManifest'])


    def backwards(self, orm):
        # Deleting model 'ModuleManifest'
        db.delete_table(u'sideloader_modulemanifest')

        # Deleting model 'ServerManifest'
        db.delete_table(u'sideloader_servermanifest')
