...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Build'
        db.create_table(u'sideloader_build', (
        ...
        db.send_create_signal(u'sideloader', ['Build'])

        # Adding field 'Project.idhash'
        db.add_column(u'sideloader_project', 'idhash',
                      self.gf('django.db.models.fields.CharField')(default='123', max_length=48),
                      keep_default=False)

        # Adding M2M table for field allowed_users on 'Project'
        m2m_table_name = db.shorten_name(u'sideloader_project_allowed_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'sideloader.project'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sideloader_build')

        # Deleting field 'Project.idhash'
        db.delete_column(u'sideloader_project', 'idhash')

        # Removing M2M table for field allowed_users on 'Project'
        db.delete_table(db.shorten_name(u'sideloader_project_allowed_users'))
