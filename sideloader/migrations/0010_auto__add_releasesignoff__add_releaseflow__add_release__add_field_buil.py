...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReleaseSignoff'
        db.create_table(u'sideloader_releasesignoff', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.Release'])),
            ('signature', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('idhash', self.gf('django.db.models.fields.CharField')(max_length=48)),
            ('signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'sideloader', ['ReleaseSignoff'])

        # Adding model 'ReleaseFlow'
        db.create_table(u'sideloader_releaseflow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.Project'])),
            ('stream', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ReleaseStream'])),
            ('require_signoff', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('signoff_list', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('quorum', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('auto_release', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'sideloader', ['ReleaseFlow'])

        # Adding model 'Release'
        db.create_table(u'sideloader_release', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('release_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('flow', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ReleaseFlow'])),
            ('build', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.Build'])),
        ...
        db.send_create_signal(u'sideloader', ['Release'])

        # Adding field 'Build.build_file'
        db.add_column(u'sideloader_build', 'build_file',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReleaseSignoff'
        db.delete_table(u'sideloader_releasesignoff')

        # Deleting model 'ReleaseFlow'
        db.delete_table(u'sideloader_releaseflow')

        # Deleting model 'Release'
        db.delete_table(u'sideloader_release')

        # Deleting field 'Build.build_file'
        db.delete_column(u'sideloader_build', 'build_file')
    ...
    models = {
        ...
        u'sideloader.releaseflow': {
            ...
            'stream': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sideloader.ReleaseStream']"})
        },
