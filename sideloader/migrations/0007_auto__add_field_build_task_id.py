...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.task_id'
        db.add_column(u'sideloader_build', 'task_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.task_id'
        db.delete_column(u'sideloader_build', 'task_id')
    ...
    models = {
        ...
        u'sideloader.build': {
            ...
            'task_id': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
