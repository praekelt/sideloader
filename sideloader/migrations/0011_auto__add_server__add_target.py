...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Server'
        db.create_table(u'sideloader_server', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'sideloader', ['Server'])

        # Adding model 'Target'
        db.create_table(u'sideloader_target', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.Server'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sideloader.ReleaseFlow'])),
        ))
        db.send_create_signal(u'sideloader', ['Target'])


    def backwards(self, orm):
        # Deleting model 'Server'
        db.delete_table(u'sideloader_server')

        # Deleting model 'Target'
        db.delete_table(u'sideloader_target')
