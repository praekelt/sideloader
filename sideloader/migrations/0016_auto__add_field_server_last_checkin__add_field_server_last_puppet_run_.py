...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.last_checkin'
        db.add_column(u'sideloader_server', 'last_checkin',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Server.last_puppet_run'
        db.add_column(u'sideloader_server', 'last_puppet_run',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Server.status'
        db.add_column(u'sideloader_server', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Server.change'
        db.add_column(u'sideloader_server', 'change',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.last_checkin'
        db.delete_column(u'sideloader_server', 'last_checkin')

        # Deleting field 'Server.last_puppet_run'
        db.delete_column(u'sideloader_server', 'last_puppet_run')

        # Deleting field 'Server.status'
        db.delete_column(u'sideloader_server', 'status')

        # Deleting field 'Server.change'
        db.delete_column(u'sideloader_server', 'change')
