...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.notifications'
        db.add_column(u'sideloader_project', 'notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Project.slack_channel'
        db.add_column(u'sideloader_project', 'slack_channel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.notifications'
        db.delete_column(u'sideloader_project', 'notifications')

        # Deleting field 'Project.slack_channel'
        db.delete_column(u'sideloader_project', 'slack_channel')
