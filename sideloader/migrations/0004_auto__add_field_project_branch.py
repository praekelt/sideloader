...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sideloader_project', 'branch',
                      self.gf('django.db.models.fields.CharField')(default='develop', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.branch'
        db.delete_column(u'sideloader_project', 'branch')
