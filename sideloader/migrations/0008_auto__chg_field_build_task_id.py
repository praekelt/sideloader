...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sideloader_build', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Build.task_id'
        db.alter_column(u'sideloader_build', 'task_id', self.gf('django.db.models.fields.IntegerField')())
