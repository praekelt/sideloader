...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.deploy_file'
        db.add_column(u'sideloader_project', 'deploy_file',
                      self.gf('django.db.models.fields.CharField')(default='.deploy.yaml', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.deploy_file'
        db.delete_column(u'sideloader_project', 'deploy_file')
