...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.specter_status'
        db.add_column(u'sideloader_server', 'specter_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.specter_status'
        db.delete_column(u'sideloader_server', 'specter_status')
